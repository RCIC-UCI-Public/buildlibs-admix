...
## [Unreleased](https://github.com/RCIC-UCI-Public/buildlibs-admix/compare/2.5...HEAD)

### Commits

- update copyright [`ebeb717`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/ebeb7170f99d1f5e3118e037bf5507e00921fc7a)
- use actual rpm size [`ce8f70d`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/ce8f70db8eb991293fb14876924ac7256a5b60ba)
- llvm rpm size update due to using native compiler [`9be8193`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/9be8193274dfb71c504c39a22347db57899c432a)
- Set rpmBuildIdLinks:none for llvm-project.yaml. On latest update of [`9a72078`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/9a72078886e9e23b4ebd938fea4c2dcb64f4b393)
- update rpmdb [`2af97b6`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/2af97b6906ba8da52bce900cb3445b6a4de05052)
- add boost 1.90.0. The githib locaiton foor distro packages have changed [`0dadd1d`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/0dadd1df2932f6568a8bc1f73c920bb417b56dd5)
- use system compiler for llvm/clang. The llvm is needed for [`bb8d6bf`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/bb8d6bf7916167eb59523eebd7f879dcb4d5491e)
- downgrade llvm/clang from v.21 series to v20 series. [`999c89a`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/999c89af7e1caa696e0f85e411c7a23ec1bb8790)
- add library definition for geos module [`2015f37`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/2015f37e324d9eb84f3bb74f10072616530b4539)
- add libgit2 1.8.5 and geos 3.14.1 [`6efe042`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/6efe042a2e8af6f34d76b7e65927df76ac10cf7b)
- add sources for ucx 1.20.0 and openmpi 5.0.9 [`da7a6b6`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/da7a6b6edc966c6a5b977c475205bc296ee8bd88)
- add latest ucx 1.20.0 and openmpi 5.0.9. [`babeabe`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/babeabeafaba91e5fa3fc0bcf08338680c140afb)
- update rpmdb for rocky 9.7 [`14d19bd`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/14d19bd14a2c4dc8f6ef584a1256258f59709ce2)
- add admix expected rpms sizes [`98f76f5`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/98f76f5f7ae7df1e7436afaa312780b45f935e10)
- ignore build stage directories [`7f62b03`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/7f62b03d7ec6abc368abfde6c928475131bb55f6)
- minor short description update [`a18f4f1`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/a18f4f17a2e4c180cb7133c5a0dec8d072d07a10)
- fix a typo ... [`86745c8`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/86745c84a41f0f1a3b4e96f22202d590e998124b)
- A "fun" one. When configure args refer to environment variables set by [`6bd5915`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/6bd59158353587516e420e15fff05b84e40b476a)
- fix typo [`6e1adf6`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/6e1adf678d1d2b9c5da5c3a4956bfbb226ae624b)
- The first statement of the description shdold [`cff2dc4`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/cff2dc4f85a90beb01e7e4ef1c556314878b96b0)
- Dont build protobuf, unused. Available from sys RPMs. [`eda574e`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/eda574e58bdc8b7fc803e52320e05c5d1653002b)
- build mpich 4.0 with the system gcc [`8d5ab39`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/8d5ab393315695fc747b2762928d0c3bc79b4a40)
- revert last commit related to ucx. [`b37895e`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/b37895e0b3a6c2f8b3490e4f5ffdecc70b896575)
- need ucx with system compiler for this set [`c54cd3f`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/c54cd3f7e8b02fc281ee15b94ce0cde9db4d426d)
- 1. ucx versions 1.12.0 is required for openmpi in both the intel2022 and [`a306fcd`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/a306fcdeed5a606cb4b462c7dba3ef2927f5b78b)
- Get rid of R404-specific set.  The combination of sqlite3,geos,proj,gdal [`18ba067`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/18ba0670bca42fb231b45cc2b850dc93b153349d)
- create a base set for the basic build. [`681b857`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/681b8570b22165d9b4f5fa6b967ff47609f51400)
- Th R404 set is because R 4.0.4 is now compiled with gcc 11.2.0. [`0d72409`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/0d72409fad7a339ecd374c7b22b401f9e6086025)
- need to use an older compierl for older verions of [`30b403f`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/30b403fe15590ce4f9891d006fccae8b7cea9af5)
- specify which gcc to use. [`08adf97`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/08adf9749e0ebff59b83d29a2fb4cde170d32ac4)
- No need to force the compiler when loading the libgit2 module. [`a61eff9`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/a61eff960ca274dfe6ac937f9f1059d63ef36923)
- Don't autoload the compiler that llvm was built with -- this can cause [`542473e`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/542473e5c7bec4f8e4946aaa359b7901f661e649)
- move ucx to system set. It is needed for openmpi and mpich build [`6e1ebad`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/6e1ebadb7d4848da0bd8d03f054f5863c1170201)
- For Rocky9, remove the intel 2020u2 compiler. It doesn't function on [`4f25144`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/4f25144073c59ed2b897a677e9e836099a931700)
- ucx 1.8.0 (pretty old) needs to be compiled with an older gcc on Rocky [`b45e2b2`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/b45e2b2d9c018691815e43f312e22c2a21245e81)
- add admix name [`65cfde8`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/65cfde8caed48aba9a7ec4edd89a26ef573dc713)
- rewrite sets. Consolidate where possible to minimize set number [`21ae83c`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/21ae83cc438ebe43a3256fff35e2f32859ab0a54)

## [2.5](https://github.com/RCIC-UCI-Public/buildlibs-admix/compare/2.0...2.5) - 2025-01-21

### Commits

- run auto-changelog before tagging [`9865e3f`](https://github.com/RCIC-UCI-Public/buildlibs-admix/commit/9865e3f358b18c12c04ddfc8cdbced13a4dd4386)
